...
gRA_PM_MN_Load = [false,true] select (["CRA_PM_MN_Load", 0] call BIS_fnc_getParamValue);
gRA_PM_MN_Clutter = [false,true] select (["CRA_PM_MN_Clutter", 0] call BIS_fnc_getParamValue);
