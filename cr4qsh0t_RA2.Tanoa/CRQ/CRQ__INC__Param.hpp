...
class Params {
	...
	class CRQ_PM_EN_Grass {
		title = " ------  System | Environment | Grass";
		texts[] = {"Ignored", "Grid 50.000 - None","Grid 37.500 - Less","Grid 25.000 - Normal","Grid 18.750 - More","Grid 12.500 - Max","Grid 06.250","Grid 03.125","Grid 01.563","Grid 00.782"};
		values[] = {0, 50000,37500,25000,18750,12500,6250,3125,1563,782};
		default = 50000;
	};
	/*
	class CRQ_PM_EN_Weather {
		title = " ------  System | Environment | Weather -- NOT YET IMPLEMENTED";
	...
	class CRQ_PM_EN_Fog {
		title = " ------  System | Environment | Fog -- NOT YET IMPLEMENTED";
		texts[] = {"Never","Always"};
		values[] = {0,100};
		default = 0;
	};
	...
	*/
	...
	class CRQ_PM_PL_Fatigue {
		title = " ------  Player | Unit | Fatigue";
		texts[] = {"Ignored","Disable", "Force"};
		values[] = {1,0,2};
		default = 0;
	};
	class CRQ_PM_PL_Stamina {
		title = " ------  Player | Unit | Stamina";
		texts[] = {"Ignored","Disable", "Force"};
		values[] = {1,0,2};
		default = 0;
	};
	...
	class CRQ_PM_PL_Sway {
		title = " ------  Player | Firearm | Weapon Sway [%]"; // TODO 25171 add option to ignore
	...
	class CRQ_PM_Label_Footer : CRQ_PM_Label_Header {
		title = "";
	};
