...
#define CRA_LC_INV_SIZE 250000
#define CRA_LC_INV_GATHER 250
#define CRA_LC_INTEL_RANGE 250
...
#define CRA_LC_ID_PFIX "CRA_"
#define CRA_LC_ID_NONE (CRA_LC_ID_PFIX + "")
#define CRA_LC_ID_BASE (CRA_LC_ID_PFIX + "HQ_")
#define CRA_LC_ID_ROAD (CRA_LC_ID_PFIX + "RB_")
#define CRA_LC_ID_DEPO (CRA_LC_ID_PFIX + "DP_")
#define CRA_LC_ID_POST (CRA_LC_ID_PFIX + "OP_")
...
#define CRA_LC_MRK_NONE   []
#define CRA_LC_MRK_BASE   ["b_hq","n_hq","o_hq","c_unknown"]
#define CRA_LC_MRK_ROAD   ["b_recon","n_recon","o_recon","c_unknown"]
#define CRA_LC_MRK_POST   ["b_support","n_support","o_support","c_unknown"]
#define CRA_LC_MRK_DWHEEL ["b_motor_inf","n_motor_inf","o_motor_inf","c_car"]
#define CRA_LC_MRK_DTRACK ["b_armor","n_armor","o_armor","c_car"]
#define CRA_LC_MRK_DWING  ["b_plane","n_plane","o_plane","c_plane"]
#define CRA_LC_MRK_DBOAT  ["b_naval","n_naval","o_naval","c_ship"]
#define CRA_LC_MRK_DROTOR ["b_air","n_air","o_air","c_air"]

#define CRA_LC_FNC_ID_NONE {CRA_LC_ID_NONE}
...
#define CRA_LC_FNC_LBL_NONE {CRA_LC_LBL_NONE}
...
#define CRA_LC_FNC_MRK_NONE [CRA_LC_FNC_ID_NONE, CRA_LC_FNC_LBL_NONE]
#define CRA_LC_FNC_MRK_BASE [CRA_LC_FNC_ID_BASE, CRA_LC_FNC_LBL_BASE]
#define CRA_LC_FNC_MRK_ROAD [CRA_LC_FNC_ID_ROAD, CRA_LC_FNC_LBL_ROAD]
#define CRA_LC_FNC_MRK_POST [CRA_LC_FNC_ID_POST, CRA_LC_FNC_LBL_POST]
#define CRA_LC_FNC_MRK_DEPO [CRA_LC_FNC_ID_DEPO, CRA_LC_FNC_LBL_NONE]
...
#define CRA_LC_CFG_CAPITAL  [CRA_LC_HIDE,CRA_LC_LBL_BASE,CRA_LC_FNC_ID_BASE,CRA_LC_FNC_LBL_BASE, -1,CRA_LC_VALUE_HIGH,CRA_LC_CAPT_SIDE,[CRA_LC_FNC_MRK_BASE,CRA_LC_MRK_BASE]]
#define CRA_LC_CFG_CITY     [CRA_LC_HIDE,CRA_LC_LBL_BASE,CRA_LC_FNC_ID_BASE,CRA_LC_FNC_LBL_BASE, -1,CRA_LC_VALUE_MED, CRA_LC_CAPT_SIDE,[CRA_LC_FNC_MRK_BASE,CRA_LC_MRK_BASE]]
#define CRA_LC_CFG_VILLAGE  [CRA_LC_HIDE,CRA_LC_LBL_BASE,CRA_LC_FNC_ID_BASE,CRA_LC_FNC_LBL_BASE, -1,CRA_LC_VALUE_LOW, CRA_LC_CAPT_SIDE,[CRA_LC_FNC_MRK_BASE,CRA_LC_MRK_BASE]]
#define CRA_LC_CFG_LOCALITY [CRA_LC_HIDE,CRA_LC_LBL_BASE,CRA_LC_FNC_ID_BASE,CRA_LC_FNC_LBL_BASE, -1,CRA_LC_VALUE_LOW, CRA_LC_CAPT_SIDE,[CRA_LC_FNC_MRK_BASE,CRA_LC_MRK_BASE]]
#define CRA_LC_CFG_AIRPORT  [CRA_LC_HIDE,CRA_LC_LBL_BASE,CRA_LC_FNC_ID_BASE,CRA_LC_FNC_LBL_BASE, -1,CRA_LC_VALUE_HIGH,CRA_LC_CAPT_SIDE,[CRA_LC_FNC_MRK_BASE,CRA_LC_MRK_BASE]]
#define CRA_LC_CFG_ROAD     [CRA_LC_HIDE,CRA_LC_LBL_ROAD,CRA_LC_FNC_ID_ROAD,CRA_LC_FNC_LBL_ROAD,100,CRA_LC_VALUE_NONE,CRA_LC_CAPT_NONE,[CRA_LC_FNC_MRK_ROAD,CRA_LC_MRK_ROAD]]
#define CRA_LC_CFG_POST     [CRA_LC_HIDE,CRA_LC_LBL_POST,CRA_LC_FNC_ID_POST,CRA_LC_FNC_LBL_POST,100,CRA_LC_VALUE_NONE,CRA_LC_CAPT_NONE,[CRA_LC_FNC_MRK_POST,CRA_LC_MRK_POST]]
#define CRA_LC_CFG_DWHEEL   [CRA_LC_HIDE,CRA_LC_LBL_DEPO,CRA_LC_FNC_ID_DEPO,CRA_LC_FNC_LBL_DEPO,  0,CRA_LC_VALUE_NONE,CRA_LC_CAPT_NONE,[CRA_LC_FNC_MRK_DEPO,CRA_LC_MRK_DWHEEL]]
#define CRA_LC_CFG_DTRACK   [CRA_LC_HIDE,CRA_LC_LBL_DEPO,CRA_LC_FNC_ID_DEPO,CRA_LC_FNC_LBL_DEPO,  0,CRA_LC_VALUE_NONE,CRA_LC_CAPT_NONE,[CRA_LC_FNC_MRK_DEPO,CRA_LC_MRK_DTRACK]]
#define CRA_LC_CFG_DWING    [CRA_LC_HIDE,CRA_LC_LBL_DEPO,CRA_LC_FNC_ID_DEPO,CRA_LC_FNC_LBL_DEPO,  0,CRA_LC_VALUE_NONE,CRA_LC_CAPT_NONE,[CRA_LC_FNC_MRK_DEPO,CRA_LC_MRK_DWING]]
#define CRA_LC_CFG_DBOAT    [CRA_LC_HIDE,CRA_LC_LBL_DEPO,CRA_LC_FNC_ID_DEPO,CRA_LC_FNC_LBL_DEPO,  0,CRA_LC_VALUE_NONE,CRA_LC_CAPT_NONE,[CRA_LC_FNC_MRK_DEPO,CRA_LC_MRK_DBOAT]]
#define CRA_LC_CFG_DROTOR   [CRA_LC_HIDE,CRA_LC_LBL_DEPO,CRA_LC_FNC_ID_DEPO,CRA_LC_FNC_LBL_DEPO,  0,CRA_LC_VALUE_NONE,CRA_LC_CAPT_NONE,[CRA_LC_FNC_MRK_DEPO,CRA_LC_MRK_DROTOR]]
...
["Malden_C_Airport", [CRA_LC_TYPE_AIRPORT, [],[600,600],"",""]],\
["Malden_L_Pegsus", [CRA_LC_TYPE_AIRPORT, [],[450,450],"",""]]]

#define CRA_LCRB_TYPES ["MAIN ROAD", "ROAD", "TRACK"]
#define CRA_LCRB_WEIGHTS [0.40, 0.25, 0.15]
#define CRA_LCRB_SCANS 25
#define CRA_LCRB_DENSITY 25
